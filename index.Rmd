...
We sampled 1000 random images out of the ~138k that are currently accessioned into [SDR](https://sdr.stanford.edu) and generated labels using the [Google Vision](https://cloud.google.com/vision/) API [**GV**][^1] and the [Clarifai Predict](https://clarifai.com/demo) API [**CP**].  
